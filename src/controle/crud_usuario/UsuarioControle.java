...
public class UsuarioControle {
	...
	public void login(ActionEvent event) {
		try {
			...
			if (vo != null && !vo.getEstadoLogado()) {
				...
				addMensage("Usu�rio", vo.getNome() + " Logado com sucesso!");
				...
				FacesContext.getCurrentInstance().addMessage("formLogin",
						new FacesMessage("Usu�rio Logado no sistema"));
			}
	...
	public void cadastrarUsuario(ActionEvent event) {
		try {
			...
			addMensage("Usuário", "Usu�rio Cadastrado com sucesso!");
			...
			FacesContext.getCurrentInstance().addMessage("formCadastro",
					new FacesMessage("Usu�rio Cadastrado com sucesso, verificar o e-mail: " + vo.getEmail()));
			vo = new UsuarioVO();
			login = "";
			senha = "";
		} catch (UsuarioVOException e) {
	...
	public void deslogar(ActionEvent event) {
		...
		try {
			addMensage("Usu�rio", "Usu�rio Desconectado com sucesso!");
